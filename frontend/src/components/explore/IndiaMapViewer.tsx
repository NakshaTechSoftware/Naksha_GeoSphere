...
function addDefaultBaseLayers(map: MapLibreMap, beforeId?: string, boundariesVisible = true) {
...
function updateBaseLabelVisibility(map: MapLibreMap, boundariesVisible = true) {
  ...
  if (map.getLayer(OSM_LABELED_LAYER_ID) && map.getLayer(OSM_NOLABELS_LAYER_ID)) {
    ...
    map.setLayoutProperty(
      OSM_LABELED_LAYER_ID,
      "visibility",
      hideRasterLabels ? "none" : "visible",
    );
    map.setLayoutProperty(
      OSM_NOLABELS_LAYER_ID,
      "visibility",
      hideRasterLabels ? "visible" : "none",
    );
  }
